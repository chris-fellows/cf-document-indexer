...
{
    /// <summary>
    /// Indexes .gif files. If a .tags file exists then IndexedDocument.Tags will be set.
    /// </summary>
    public class GifFileIndexer : IDocumentIndexer
    {
        ...
        {
            return documentFile.ToLower().EndsWith(".gif");
        }
    }
}
