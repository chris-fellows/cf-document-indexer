...
{
    /// <summary>
    /// Indexes .ico files. If a .tags file exists then IndexedDocument.Tags will be set.
    /// </summary>
    public class IcoFileIndexer : IDocumentIndexer
    {
        ...
        {
            return documentFile.ToLower().EndsWith(".ico");
        }
    }
}
