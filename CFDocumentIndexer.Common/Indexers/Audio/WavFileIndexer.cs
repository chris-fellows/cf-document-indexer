...
namespace CFDocumentIndexer.Indexers.Audio
{
    /// <summary>
    /// Indexes .wav files. If a .tags file exists then IndexedDocument.Tags will be set.
    /// </summary>
    public class WavFileIndexer : IDocumentIndexer
    {
        ...
        {
            return documentFile.ToLower().EndsWith(".wav");
        }
    }
}
