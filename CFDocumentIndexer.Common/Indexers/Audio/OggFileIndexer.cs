...
{
    /// <summary>
    /// Indexes .ogg files. If a .tags file exists then IndexedDocument.Tags will be set.
    /// </summary>
    public class OggFileIndexer : IDocumentIndexer
    {
        ...
        {
            return documentFile.ToLower().EndsWith(".ogg");
        }
    }
}
