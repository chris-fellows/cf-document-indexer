...
{
    /// <summary>
    /// Indexes video files. If a .tags file exists then IndexedDocument.Tags will be set.
    /// </summary>
    public class Mp4FileIndexer : IDocumentIndexer
    {
        ...
        {
            return documentFile.ToLower().EndsWith(".mp4");
        }
    }
}
